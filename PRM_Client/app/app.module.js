System.register(['@angular/core', '@angular/platform-browser', './app.component', './app.article', './app.text-editor', './app.article-list', './app.articles', './feedback', './app.loginComponent'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, platform_browser_1, app_component_1, app_article_1, app_text_editor_1, app_article_list_1, app_articles_1, feedback_1, app_loginComponent_1;
    var AppModule;
    return {
        setters:[
            function (core_1_1) {
